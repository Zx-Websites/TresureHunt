...
export const ICAT_2026_SECRETS: HuntSecrets = {
  ...
  codes: {
    ...
    "P2_Game Lounge": { code: "LOUNGE" },
    "P2_503": { code: "SYNAPSE503" },
    "P2_Staff Lunch": { code: "PANTRY" },
    "P2_305": { code: "MATRIX305" },
    ...
    "P3_Staff room": { code: "STAFFROOM" },
    "P3_306": { code: "UIUX306" },
    "P3_Library": { code: "LIBRARY" },
